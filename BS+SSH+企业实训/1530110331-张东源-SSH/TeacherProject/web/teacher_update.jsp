        ...
        <tr>
            <div>
                <table border="0" width="100%">
                    ...
                    <s:form name="form1" method="post" action="teacher_Update" theme="simple">
                        <s:iterator value="#session.listteacher" var="teacher">
                            <tr align="center" style="height: 50px;font-size: 20px;">
                                <td>教师编号:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <s:textfield name="teacher.teacherid" value="%{#teacher.teacherid}" type="text"/></td>
                            </tr>

                            <tr align="center" style="height: 50px;font-size: 20px;">
                                <td>教师名称:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <s:textfield name="teacher.teachername" value="%{#teacher.teachername}" type="text"/></td>
                            </tr>

                            <tr align="center" style="height: 50px;font-size: 20px;">
                                <td>教师工龄:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <s:textfield name="teacher.workage" value="%{#teacher.workage}" type="text"/></td>
                            </tr>

                            <tr align="center" style="height: 50px;font-size: 20px;">
                                <td>教师工资:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <s:textfield name="teacher.wage" value="%{#teacher.wage}" type="text"/></td>
                            </tr>

                            <tr align="center" style="height: 50px;font-size: 20px;">
                                <td>教师电话:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <s:textfield name="teacher.tel" value="%{#teacher.tel}" type="text"/></td>
                            </tr>
                         </s:iterator>
                            <tr height="20px">

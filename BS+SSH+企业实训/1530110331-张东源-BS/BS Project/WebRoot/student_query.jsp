...
<html>
  ...
  <td style="padding:5px;"><%=student.getStudentid()%></td>
   ...
   <td style="padding:5px;"><%=student.getCoursename()%></td>   
   <td style="padding:5px;"><%=student.getSex()%></td>
    <td style="padding:5px;"><%=student.getScore()%></td>
    ...
    <td align="center"><a href="StudentDeleteServlet?studentid=<%=student.getStudentid()%>" onclick="javascript:if(confirm('确定要删除吗')){alert('删除成功!');return true;}return false;"
    >删除</a></td> 

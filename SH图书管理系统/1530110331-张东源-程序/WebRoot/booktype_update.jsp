...
<link href="CSS/style.css" rel="stylesheet">   
  ...
  <tr>
   ...
   <s:form name="form1" method="post" action="BookType_update" theme="simple">
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
       <tr>
  
       <td height="50" align="center">  图书类型名称：
       <s:textfield name="b.booktypeid" type="hidden" value="%{#session.booktypeid}"/>
       <s:textfield name="b.booktypename" type="text" value="%{#session.booktypename}"/>

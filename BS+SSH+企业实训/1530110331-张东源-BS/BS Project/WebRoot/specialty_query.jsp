...
<html>
  ...
  <tr>
   <td style="padding:5px;"><%=specialty.getSpecialtyid()%></td>
    ...
    <td align="center"><a href="SpecialtyDeleteServlet?specialtyid=<%=specialty.getSpecialtyid() %>" onclick="javascript:if(confirm('确定要删除吗')){alert('删除成功!');return true;}return false;"
    >删除</a></td> 
  </tr>
<%
	}

...
<html>
  <head>
    ...
    <title>My JSP 'course_query.jsp' starting page</title>
     ...
     <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
      <tr>
       ...
       <tr>
         ...
         <table width="98%" height="420"  border="1" cellpadding="0" cellspacing="0">
      <tr>
 ...
 %>
  <tr>
   <td style="padding:5px;"><%=course.getCourseid()%></td>
    ...
    <td align="center"><a href="CourseDeleteServlet?courseid=<%=course.getCourseid()%>">删除</a></td> 
  </tr>
<%
	}
 %>

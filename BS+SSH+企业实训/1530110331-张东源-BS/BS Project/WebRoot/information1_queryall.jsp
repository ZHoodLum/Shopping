        ...
        <td height="273" align="center" valign="top">
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
           ...
           <td width="100%" align="center"><br>
           	<a href="error-404.jsp" style="color:blue">发布通知信息</a><br><br><br>
            </td>       
          </tr>
          </table>
          
 
  <table width="91%"  border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#F6B83B" bordercolorlight="#FFFFFF">
 ...
 %>
  <tr align="center">
   <td style="padding:5px;"><%=information.getInformationid()%></td>
    <td align="center"><a style="color:red" href="error1-404.jsp"><%=information.getInformationname()%></a></td>
  </tr>
<%
	}
 %>

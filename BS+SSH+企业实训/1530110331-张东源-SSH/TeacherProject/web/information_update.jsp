        ...
        <tr>
            <div>
                <table border="0" width="100%">
                    ...
                    <s:form name="form1" method="post" action="information_Update" theme="simple">
                        <s:iterator value="#session.listinformation" var="information">
                            <tr align="center" style="height: 50px;font-size: 20px;">
                                <td>公告信息编号:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <s:textfield name="information.informationid" value="%{#information.informationid}" type="text"/></td>
                            </tr>

                            <tr align="center" style="height: 50px;font-size: 20px;">
                                <td>公告信息名称:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                    <s:textfield name="information.informationname" value="%{#information.informationname}" type="text"/></td>
                            </tr>
